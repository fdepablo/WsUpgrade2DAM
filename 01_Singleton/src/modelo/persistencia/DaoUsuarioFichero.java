...
import sigleton.ClaseSingleton;

public class DaoUsuarioFichero {
	private static final String NOMBRE_FICHERO = "usuarios.dat";
	
	private static DaoUsuarioFichero instance = null;
	
	private DaoUsuarioFichero() {
		
	}
	
	public static DaoUsuarioFichero getInstance() {
		if(instance == null) {
			instance = new DaoUsuarioFichero();
		}
		return instance;
	}
